        ...
        <div className="columns-3 gap-2 h-full">
            ...
            <div className="bg-[#f8f3f9] p-5 rounded-lg h-full space-y-4 overflow-y-auto">
                <div className="flex flex-row justify-between">
                    ...
                    <div className="flex py-2 px-3 bg-white rounded-full">
                        <span className="text-xs">24 Categories</span>
                    </div>
                </div>
                <div className="grid grid-cols-2 gap-2">
                    {
                        categories.map(( category) => {
                            ...
                            return (
                                <div className="aspect-square bg-white rounded-lg p-2 flex flex-col justify-between">
                                    <div className="flex justify-end">
                                        <Badge className="rounded-full bg-[#e9ecfa] text-[#641713]">
                                            <CheckIcon/>
                                            <span>Selected</span>
                                        </Badge>
                                    </div>
                                    <div className="flex justify-center">
                                        <div className="rounded-full w-10 h-10 bg-[#f8f3f9] flex justify-center items-center">
                                            <Icon size={14} />
                                        </div>
                                    </div>
                                    <div className="flex">
            ...
            <div className="bg-[#f8f3f9] p-5 rounded-lg h-full space-y-4 overflow-y-auto">
                <div className="flex flex-row justify-between">
                    ...
                    <div className="flex py-2 px-3 bg-white rounded-full">
                        <span className="text-xs">24 Products</span>
                    </div>
                </div>
                        ...
                        Array.from({ length: 5 }).map((_) => (
                            <div className="w-full p-4 bg-white rounded-lg flex flex-row gap-2">
                                <div className="aspect-square w-[40%] rounded-lg overflow-clip">
                                    <img src={productExampleImg} alt="product-eg" className="w-full h-full object-cover" />
                                </div>
                                <div className="w-full flex flex-col gap-2">
                                    <h2 className="text-[#641713] font-bold">Lenovo Laptop 2GB Ram</h2>
                                    <p className="text-slate-500 text-xs">Lorem ipsum dolor sit amet, consectetur
