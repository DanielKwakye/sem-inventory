...
function AuthIndexPage() {
    ...
    return (
        <>
                    ...
                    <div className={"flex flex-col md:min-w-sm space-y-8 md:space-y-12"}>
                        ...
                        <div className={"flex gap-4 w-full"}>
                            <AnimatedInView delay={0.1} className={"w-full"}>
                                <PasswordDialog systemReady={systemReady} onLoginSuccess={() => loginHandler("admin")}/>
                            </AnimatedInView>
                        ...
                        <div>
                            <BackendLoader onReady={() => setSystemReady(true)}/>
                            <p className="tracking-wide text-muted-foreground text-sm">The Demo backend usually goes
                                down after sometime of inactivity </p>
                        </div>
                            ...
                            <div className={"bg-white/10 p-4 rounded-lg"}>
                                <div className="flex items-start">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-white/80 text-sm mt-1">Admin can add and update inventory,
                                            manage
            ...
            <SystemReadinessDialog ref={systemReadyRef} />
        </>
    )
}
